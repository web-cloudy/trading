...
const registerValidation = data => {
  ...
  errors.firstName = lengthInput(firstName, 3, 30, 'Name should be between 2 and 30 characters');
  errors.lastName = lengthInput(lastName, 3, 30, 'Name should be between 2 and 30 characters');
  ...
  // Empty validation
  if (Validator.isEmpty(firstName)) errors.fistName = 'Name field is required';
